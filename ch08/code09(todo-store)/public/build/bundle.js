...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			add_location(h1, file$4, 15, 4, 273);
    			attr_dev(input, "type", "text");
    			add_location(input, file$4, 16, 4, 303);
    			attr_dev(div, "class", "wrap");
    			add_location(div, file$4, 14, 2, 250);
    			add_location(header, file$4, 13, 0, 239);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<TodoHeader> was created with unknown prop '${key}'`);
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			add_location(span, file$3, 19, 2, 549);
    		},
    		m: function mount(target, anchor) {
    ...
    // (17:0) {#if $todos.editMode === todo.id }
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "type", "text");
    			add_location(input, file$3, 17, 2, 463);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "focusout", /*handleEditTodo*/ ctx[4], false, false, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(17:0) {#if $todos.editMode === todo.id }",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 15, 0, 348);
    			attr_dev(a, "href", "#null");
    			add_location(a, file$3, 21, 0, 622);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "click", /*handleCheckTodo*/ ctx[2], false, false, false),
    ...
    // (10:4) {#each $fetchTodos as todo, index(todo.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(li, file$2, 10, 6, 263);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    		...
    		a: function animate() {
    			stop_animation();
    			stop_animation = create_animation(li, rect, flip, { duration: 1000 });
    		},
    		...
    		o: function outro(local) {
    			...
    			li_outro = create_out_transition(li, fade, { duration: 100 });
    			current = false;
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:4) {#each $fetchTodos as todo, index(todo.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 8, 2, 204);
    ...
    const file$1 = "src/components/TodoInfo.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TodoHeader, TodoList, TodoInfo });
    	return [];
    }
