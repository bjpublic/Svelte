...
var app = (function () {
    ...
    /* src/components/SubContent.svelte generated by Svelte v3.42.1 */
    const file$5 = "src/components/SubContent.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Sub Content";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = `param: ${/*param*/ ctx[1]}`;
    			t4 = space();
    			p1 = element("p");
    			p1.textContent = `현재 url: ${/*route*/ ctx[0].url}`;
    			t7 = space();
    			p2 = element("p");
    			p2.textContent = `이전 url: ${/*route*/ ctx[0].from}`;
    			add_location(b, file$5, 7, 0, 111);
    			add_location(p0, file$5, 8, 0, 130);
    			add_location(p1, file$5, 9, 0, 152);
    			add_location(p2, file$5, 10, 0, 179);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('SubContent', slots, []);
    	const route = y();
    	let param = route.params._id;
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<SubContent> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ meta: y, route, param });
    ...
    class SubContent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    // (12:2) <Route path="/sub/:_id">
    function create_default_slot$1(ctx) {
    	let subcontent;
    	let current;
    	subcontent = new SubContent({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(subcontent.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(subcontent, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(subcontent.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(subcontent.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(subcontent, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:2) <Route path=\\\"/sub/:_id\\\">",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			hr1 = element("hr");
    			add_location(h1, file$4, 6, 2, 136);
    			attr_dev(a, "href", "/about/sub/123");
    			add_location(a, file$4, 7, 2, 158);
    			add_location(hr0, file$4, 9, 2, 194);
    			add_location(hr1, file$4, 15, 2, 262);
    			attr_dev(div, "class", "main");
    			add_location(div, file$4, 5, 0, 115);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, SubContent });
    	return [];
    }
    ...
    /* src/components/Contacts.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Contacts Page";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Go Home";
    			add_location(h1, file$2, 6, 2, 121);
    			attr_dev(p, "class", "on svelte-17zf2ls");
    			add_location(p, file$2, 7, 2, 146);
    			attr_dev(div, "class", "main");
    			add_location(div, file$2, 5, 2, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(p, "click", /*goHome*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ router: f, goHome });
    	return [goHome];
    }
    ...
    /* src/Transition.svelte generated by Svelte v3.42.1 */
    const file$1 = "src/Transition.svelte";
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			add_location(div, file$1, 7, 4, 163);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			if (!div_intro) {
    				add_render_callback(() => {
    					div_intro = create_in_transition(div, fly, { x: 300, duration: 400, delay: 500 });
    					div_intro.start();
    				});
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ router: f, fade, slide, fly, $router });
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:2) <Route path=\\\"/contacts\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 5, 2, 75);
    			attr_dev(a1, "href", "/about");
    			add_location(a1, file, 6, 2, 114);
    			attr_dev(a2, "href", "/contacts");
    			attr_dev(a2, "active-class", "custom-active");
    			add_location(a2, file, 8, 2, 199);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(T.call(null, a0)),
    					action_destroyer(T.call(null, a1)),
    					action_destroyer(T.call(null, a2))
    				];
